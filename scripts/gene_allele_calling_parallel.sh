...
#                            fi
                        ...
                        vg paths -Fv ${outdir}/${sample_id}.${graph}.${gene}.${clust}.haplotypes.gfa | seqkit grep -s -p 'N' - > ${outdir}/${sample_id}.${graph}.${gene}.${clust}.haplotypes.paths.fasta
                        ...
                        fasta_N_count=$(grep ">" ${outdir}/${sample_id}.${graph}.${gene}.${clust}.haplotypes.paths.fasta | wc -l | awk '{print $1}')
        ...
        if [[ $(wc -l <${outdir}/${sample_id}.${graph}.${gene}.genotyping.immune_subset.gam.txt) -ge 1 ]]; then
            ...
            if [ $(echo "${asc_cluster[@]}" | wc -l) -gt 1 ]; then
                ...
                if [ -s ${outdir}/${sample_id}.${graph}.${gene}.succinct_locus.xg ]; then
                    ...
                    rm ${outdir}/${sample_id}.${graph}.${gene}.succinct_locus.prefilt.gam;
...
#                    fi
        ...
        #            mv ${outdir}/${sample_id}.${graph}.${gene}.alleles.base0.pg ${outdir}/${sample_id}.${graph}.${gene}.alleles.pg;
                ...
                echo "Simple locus graph - removing unmapped reads"
                vg filter -r 0 -P -q 0 -s 1 -x ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg -D 0 -fu -t 4 ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.gam -v > ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.filt.gam
            fi
            ############################################################################################################################
...
#            vg filter -r 0.95 -P -s 1 -q 5 -x ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg -D 0 -fu -t 4 ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.filt.gam -v | vg convert -G - ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg > ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.gaf
            vg filter -r 0 -P -s 1 -q 0 -x ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg -D 0 -fu -t 4 ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.filt.gam -v > ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.gam
            ############################################################################################################################
...
#            min_strain_depth=$(bc -l <<< "scale=2;(${depth_locus}*0.05)*$(echo "${asc_cluster[@]}" | wc -l)"| awk '{printf("%d\n",$1 + 0.5)}')
            ...
            #python3 ${bigfoot_dir}/parse_graph_vgflow.py --sample ${outdir}/${sample_id}.${graph}.${gene}.vgflow -m 1;
            ...
            #parsed_len=$(cut -f2 vgflow_paths.final.txt | sort | uniq);
                ...
                vg filter -r 0 -P -s 1 -q 0 -x ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg -D 0 -fu -t 4 ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.filt.gam -v | vg convert -G - ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.xg > ${outdir}/${sample_id}.${graph}.${gene}.haplotypes.gaf
                vg convert -fW ${outdir}/${sample_id}.${graph}.${gene}.vg > ${outdir}/${sample_id}.${graph}.${gene}.vgflow.final.gfa
